...
def check_idempotency(key: str, user: str = None) -> Optional[Dict[str, Any]]:
    ...
    if not key:
        return None
    existing = frappe.get_all("AI Assistant Action",
...
def claim_idempotency(key: str, session: str, user: str, action: str,
                     target_doctype: str, proposed_data: Dict[str, Any]) -> Dict[str, Any]:
...
def generate_idempotency_key(session: str, action: str, target_doctype: str,
