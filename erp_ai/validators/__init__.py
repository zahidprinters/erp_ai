...
NUMERIC_FIELDS = frozenset({
    "qty", "rate", "price", "amount", "paid_amount", "received_amount",
    "total_debit", "total_credit", "discount_percent", "standard_rate",
    "opening_stock", "min_amount", "max_amount", "valuation_rate",
    "rejected_qty", "debit_in_account_currency", "credit_in_account_currency",
    "basic_rate",
})
