...
DOCTYPE_SCHEMAS: Dict[str, Dict[str, Any]] = {
	...
	"Sales Invoice": {
		...
		"child_table": {
			...
			"optional": ["warehouse"],
			"labels": {"item_code": "Item", "qty": "Quantity", "rate": "Rate", "warehouse": "Warehouse"},
		},
	},
	"Purchase Invoice": {
	...
	"Sales Order": {
		...
		"child_table": {
			...
			"optional": ["rate", "warehouse"],
			"labels": {"item_code": "Item", "qty": "Quantity", "rate": "Rate"},
		},
	},
	"Purchase Order": {
		"required": ["supplier", "items"],
	...
	"Stock Entry": {
		...
		"defaults": {},
		"labels": {
			"stock_entry_type": "Type (Receipt/Issue/Transfer/Manufacture)",
			"items": "Items",
			"company": "Company",
			"remarks": "Remarks",
		...
		"child_table": {
			"fieldname": "items",
			"required": ["item_code", "qty"],
			"optional": ["basic_rate", "s_warehouse", "t_warehouse"],
			"labels": {
				"item_code": "Item",
				"qty": "Quantity",
				"basic_rate": "Rate",
				"s_warehouse": "Source WH",
				"t_warehouse": "Target WH",
			},
		},
	},
	"Payment Entry": {
	...
	"Material Request": {
		...
		"child_table": {
			...
			"required": ["item_code", "qty"],
			"optional": ["warehouse"],
			"labels": {"item_code": "Item", "qty": "Quantity", "warehouse": "Target Warehouse"},
		},
	},
	"Quotation": {
	...
	"Warehouse": {
		...
		"labels": {
			...
			"parent_warehouse": "Parent Warehouse",
			"company": "Company",
		},
	},
	"Price List": {
	...
	"Production Plan": {
		...
		"labels": {
			"po_items": "Items to Plan",
			"company": "Company",
			"get_items_from": "Sales Order/Material Request",
			"posting_date": "Date",
			"project": "Project",
			"for_warehouse": "For Warehouse",
			"status": "Draft/Submitted",
		},
		"child_table": {
			"fieldname": "po_items",
			"required": ["item_code", "planned_qty"],
			"optional": ["warehouse", "bom_no", "sales_order"],
			"labels": {
				"item_code": "Item",
	...
	"Asset": {
		...
		"labels": {
			...
			"location": "Location",
			"gross_purchase_amount": "Purchase Amount",
			"purchase_date": "Purchase Date",
			"is_existing_asset": "Is Existing",
		},
	},
	"Asset Maintenance": {
		...
		"child_table": {
			...
			"required": ["maintenance_task", "maintenance_type", "next_due_date"],
			"optional": ["periodicity", "assign_to", "start_date", "end_date"],
			"labels": {
	...
	"Asset Repair": {
		...
		"labels": {
			...
			"repair_status": "Completed/Pending",
			"completion_date": "Completion Date",
			"repair_cost": "Repair Cost",
			"capitalize_repair_cost": "Capitalize Cost",
			"stock_consumption": "Spare Parts Used",
			"project": "Project",
	...
	"Asset Movement": {
		...
		"child_table": {
			"fieldname": "assets",
			"required": ["asset"],
			"optional": ["source_location", "target_location", "from_employee", "to_employee"],
			"labels": {
				"asset": "Asset",
				"source_location": "From Location",
				"target_location": "To Location",
	...
	"Expense Claim": {
		...
		"child_table": {
			"fieldname": "expenses",
			"required": ["expense_date", "amount", "expense_type"],
			"optional": ["description", "sanctioned_amount"],
			"labels": {
				"expense_date": "Date",
				"amount": "Amount",
				"expense_type": "Type",
	...
	"Request for Quotation": {
		...
		"child_table": {
			"fieldname": "items",
			"required": ["item_code", "qty"],
			"optional": ["warehouse", "schedule_date"],
			"labels": {
				"item_code": "Item",
				"qty": "Quantity",
				"warehouse": "Warehouse",
		...
		if names:
			if len(names) > 1:
				...
				if len(exact) == 1:
					return exact[0]
			return names[0]
	default = frappe.defaults.get_user_default("warehouse") or frappe.db.get_single_value(
