...
def test_source_freshness_old():
	...
	old_source = KnowledgeSource(
		id="old", title="Old Source", source_type="kb_article", last_updated="2020-01-01"
	)
...
def test_source_freshness_recent():
	...
	source = KnowledgeSource(id="recent", title="Recent", source_type="kb_article", last_updated="2026-09-01")
...
def test_source_citation_format():
	...
	source = KnowledgeSource(
		id="test", title="Test Source", source_type="company_sop", version="2.0", last_updated="2026-06-01"
	)
...
def test_stale_source_flagged_in_citation():
	...
	stale_source = KnowledgeSource(
		id="stale", title="Stale SOP", source_type="company_sop", last_updated="2020-01-01"
	)
...
def test_citation_excerpt_truncated():
	...
	long_source = KnowledgeSource(id="long", title="Long", source_type="kb_article", excerpt="x" * 500)
